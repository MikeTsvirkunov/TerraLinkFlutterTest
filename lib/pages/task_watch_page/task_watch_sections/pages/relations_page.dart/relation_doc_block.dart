...
class RelationDocBlock extends StatefulWidget {
  ...
  const RelationDocBlock({Key? key, required this.docName, required this.authorName, required this.docTitle})
      : super(key: key);
  @override
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Автор: ${widget.authorName}', textScaler: const TextScaler.linear(1.1), style: const TextStyle(color: Color.fromARGB(255, 128, 130, 133)),),
          const SizedBox(height: 2.5,),
