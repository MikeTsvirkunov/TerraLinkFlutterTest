...
class UnionRequisitesExpansionTitle extends StatefulWidget {
  // final String nodeId;
  const UnionRequisitesExpansionTitle({Key? key}) : super(key: key);
  @override
  State<UnionRequisitesExpansionTitle> createState() => _UnionRequisitesExpansionTitleState();
}

class _UnionRequisitesExpansionTitleState extends State<UnionRequisitesExpansionTitle> {
